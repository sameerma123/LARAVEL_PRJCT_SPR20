            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item"><a href="<?php echo e(url('/inicio')); ?>" class="nav-link">Inicio</a></li>
                        <li class="nav-item"><a href="<?php echo e(url('/semblanza')); ?>" class="nav-link">Semblanza</a></li>
                        <li class="nav-item"><a href="<?php echo e(url('/mission')); ?>" class="nav-link">Centro Augusto Mijares</a></li>
                        <li class="nav-item"><a href="<?php echo e(url('/projects')); ?>" class="nav-link">Proyectos</a></li>
                        <li class="nav-item"><a href="<?php echo e(url('/events')); ?>" class="nav-link">Eventos</a></li>
                        <li class="nav-item"><a href="<?php echo e(url('/videos')); ?>" class="nav-link">Videos</a></li>
                        <li class="nav-item"><a href="<?php echo e(url('/members')); ?>" class="nav-link">Equipos</a></li>
                        <li class="nav-item"><a href="https://blog.nxm1645.uta.cloud/" class="nav-link">Blog</a></li>
                        <?php if(!Auth::guest()): ?>
                            <?php if(Auth::user()->adminFlag == 1): ?>
                                <li class="nav-item"><a href="<?php echo e(url('/adminPanel')); ?>" class="nav-link">Admin Panel</a></li>
                            <?php endif; ?>
                        <?php endif; ?>
                    </ul>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <?php if(auth()->guard()->guest()): ?>
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo e(route('login')); ?>"><?php echo e(__('Inicio de Session')); ?></a>
                            </li>
