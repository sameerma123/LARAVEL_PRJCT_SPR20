...
<div class="container">
    <div class="row justify-content-center">
        <div class="">
            ...
            <div class="card">
                <div class="card-header"><h2 class="bold">{{ __('Registro') }}</h2></div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="password-confirm" class="col-md-4 col-form-label text-md-right">{{ __('Repeter Contrasena') }}</label>
